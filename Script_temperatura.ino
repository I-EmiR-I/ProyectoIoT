...
const char* host = "ipv4";// IP server, obtained with 'ipconfig' in command shell
...
void loop() {
  ...
  if(currentMillis - previousMillis > watchdog){
    ...
    String strVariable1 = String(temperature, 2); // 2 indica el número de decimales

    // building our url according our database
    String url = "http://localhost/DB/indexTemperatura.php?Datos=" + strVariable1;
